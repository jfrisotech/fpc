import os
from fpc.templates.mvvm.models.user_model_template import get_user_model_content
from fpc.templates.mvvm.viewmodels.auth_viewmodel_template import get_auth_viewmodel_content
